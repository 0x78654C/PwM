...
internal class UpdateWindow : Form
{
    ...
    public UpdateWindow()
    {
        ...
        Controls.Add(layout);
        var brand = new Label { Text = "PwM   /   SOFTWARE UPDATE", ForeColor = Color.FromArgb(108, 194, 255), Font = new Font(Font, FontStyle.Bold) };
        ...
        Notes.Text = "Checking the latest PwM releases…";
    ...
    public void ShowRelease(Version installed, UpdateRelease release)
    {
        ...
        Notes.Text = string.IsNullOrWhiteSpace(release.Notes) ? "This release includes the latest PwM improvements." : release.Notes.Replace("\r\n", "\n").Replace("\n", Environment.NewLine);
    }
