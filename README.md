...
# How it works
  ...
  - Delete/Remove a vault: select the vault that you want to delete or remove(for shared valuts only) from list and press on '-' sign down bellow or right click on vault and choose 'Delete/Remove vault'. INFO: shared vaults files wont be deleted only removed from displaying on vault list.
