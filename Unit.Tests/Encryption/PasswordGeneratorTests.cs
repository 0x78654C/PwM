...
namespace Unit.Tests
{
    ...
    public class PasswordGeneratorTests
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => PwM.Encryption.PasswordGenerator.GeneratePassword(length));
        }
        [Fact]
        public void Ensure_if_we_do_not_use_any_char_types_we_are_told_about_it()
        {
            Assert.Throws<ArgumentException>(() => PwM.Encryption.PasswordGenerator.GeneratePassword(33, false, false, false, false));
        }
        ...
        {
            var password = PwM.Encryption.PasswordGenerator.GeneratePassword(length);
        ...
        {
            var password = PwM.Encryption.PasswordGenerator.GeneratePassword(20, true, false, false, false);
        ...
        {
            var password = PwM.Encryption.PasswordGenerator.GeneratePassword(20, false, true, false, false);
        ...
        {
            var password = PwM.Encryption.PasswordGenerator.GeneratePassword(20, false, false, true, false);
        ...
        {
            var password = PwM.Encryption.PasswordGenerator.GeneratePassword(20, false, false, false, true);
        ...
        {
            var password = PwM.Encryption.PasswordGenerator.GeneratePassword(20);
